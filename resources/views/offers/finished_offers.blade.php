...
<div class="cointainer-fluid">
    ...
    <main>
        <div class="szukanie">
            <input class="form-control mr-sm-2 searchs" type="text" value='{{$_GET['search'] ?? ''}}'
                placeholder="Miasto" aria-label="Search" onkeypress="logkey()" id='searchs'>
            ...
            <input type="number" class="cena-search" value='{{$_GET['cenaod'] ?? ''}}' placeholder="Cena od (pln)"
                id="cena_od"><input type="number" value='{{$_GET['cenado'] ?? ''}}' class="cena-search"
                placeholder="Cena do (pln)" id="cena_do"><br />
            <button class="btn btn-mdb-color btn-rounded btn-sm my-0 waves-effect waves-light" type="button"
                onclick="Szukaj()">Search</button><br />
            <input class="btn btn-mdb-color btn-rounded btn-sm my-0 waves-effect waves-light" type="button"
                onclick="OrderDesc()" value="Najnowsze">
            <input class="btn btn-mdb-color btn-rounded btn-sm my-0 waves-effect waves-light" type="button"
                onclick="OrderAsc()" value="Najstarsze">
        </div>
        <div class="row">
            <div class="col-md-12 page_button">
                <fieldset id="offer_buttons_fieldset">
                    ...
                    @endif
                    {{ $activePage }}
                    @if ($activePage < $pageCount) <a
                        href="/offers/{{$beforesearch}}{{$activePage+1}}{{$activesearch}}">&gt;</a>
                        @endif
                ...
                <div class="card" style='width:90%; margin-bottom:20px'>
                    ...
                    <div class="card-body">
                        ...
                        <table class="offer_table">
                            ...
                            <tr>
                                <td colspan="2"><a href="/offers/show/{{$item['id']}}"
                                        class="btn btn-primary">Oferta</a></td>
                            </tr>
                        </table>
